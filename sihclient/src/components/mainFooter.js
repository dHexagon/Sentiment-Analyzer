const MainFooter = () => {
    return ( <div className="h-96 flex justify-around items-center">
            ...
            <div className="h-4/5 w-1/2 flex justify-around">
                ...
                <div className="h-full w-1/5 flex flex-col justify-around items-center">
                     <span className="text-3xl font-alumniSans font-700 w-full">About</span>
                     <div className="w-full h-3/5 flex flex-col font-ubuntu font-normal">
                ...
                <div className="h-full w-1/5 flex flex-col justify-around items-center">
                    <span className="text-3xl font-alumniSans font-700 w-full">Connect</span>
                    <div className="w-full h-3/5 flex flex-col font-ubuntu font-normal">
                    <span>Instagram</span>
                    <span>Facebook</span>
                    <span>Twitter</span>
