...
const Employees = () => {
    ...
    return (
        <div className="m-auto w-[80%] h-[80%] p-5 ">
            <div className="font-josefinSans font-semibold text-4xl text-start flex w-full justify-between items-center"><p>Employees</p> <span><img src="/assets/main/add.svg" className=" ml-auto mr-2 "></img></span></div>
