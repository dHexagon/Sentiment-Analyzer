...
const SideBar = ({details}) => {
  ...
  return (
    <div
      className={`h-full  ${expanded === true ? "w-1/4" : "w-[10%]"
    ...
    >
      <div className="h-[95%] w-[95%] rounded-md shadow-[4px_4px_8px_0px_rgba(0,0,0,0.25)] flex flex-col justify-around items-center relative bg-white">
        <div
          className={`h-14 w-14 absolute top-2 flex items-center justify-center cursor-pointer ${expanded === true ? "left-2" : "self-center"
            } `}
        >
          <img
        ...
        <div className="flex justify-center">
          <div
            className={`w-10 flex items-center justify-center ${expanded === true ? "" : "mt-10"
              }`}
          >
            <img src="/assets/main/dHexagon.svg" alt="Logo" />
          </div>
          <span
            className={`ml-10 text-4xl font-alumniSans font-bold ${expanded === true ? "flex" : "hidden"
        ...
        <div
          className={`w-[80%] min-h-[20%] ${expanded === true ? "flex" : "hidden"
        ...
        <div
          className={`flex flex-col justify-around w-[80%] ${expanded === true ? "min-h-[35%]" : "min-h-[50%]"
            } `}
        >
          <span
            className={`${expanded === true ? "" : "hidden"
              } text-3xl font-josefinSans font-normal text-[#515151] h-[10%] mb-2`}
          >
            Quick menu
          </span>
          <div
            className={`flex ${expanded === true
          ...
          >
            {Menu.map((item) =>
              item.level >= level ? (
                <div
                  className={`h-1/2 ${expanded === true ? "w-1/2" : "w-full"
