...
Savee ="/Users/akshayv/Desktop/MLdata/savee"
...
for dir in tess_directory_list:
    if (dir==".DS_Store"):
        continue
    if(dir=="TESS Toronto emotional speech set data"):
        continue
...
joblib.dump(scaler, 'scalerBatchNormalised0005.pkl')
x_test = scaler.transform(x_test)
# list=[x_train.shape, y_train.shape, x_test.shape, y_test.shape]
...
model.optimizer.lr = custom_lr
model.summary()

rlrp = ReduceLROnPlateau(monitor='loss', factor=0.4, verbose=0, patience=2, min_lr=0.0000001)
history = model.fit(x_train, y_train, batch_size=64, epochs=45, validation_data=(x_test, y_test), callbacks=[rlrp])

model.save("recog_speechBatchNormalised0005.h5")
